#
#  Be sure to run `pod spec lint HLChartView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zhiyuehl"
  # s.authors            = { "zhiyuehl" => "775445353@qq.com" }
  # s.social_media_url   = "http://twitter.com/zhiyuehl"
...
s.source_files  = "HLChartView/*.{h,m}"
